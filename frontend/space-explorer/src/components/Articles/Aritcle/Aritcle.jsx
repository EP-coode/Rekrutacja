        ...
        <li className="space-article" key={article.id}>
            ...
            <div className="space-article__details">
                ...
                <div className="space-article__foot">
                    ...
                    <button className="space-article__like-btn" onClick={() => onFavClick(article.id)}>
                        {!favourite ? <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-heart" viewBox="0 0 16 16">
